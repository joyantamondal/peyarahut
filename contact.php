  ...
  <body>
    ...
    <header class="site-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-4 site-logo" data-aos="fade"><a href="index.html" class="animsition-link">PeyaraHut</a></div>
          <div class="col-8">
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(images/p15.png)">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            ...
            <p class="sub-heading mb-5" data-aos="fade-up" data-aos-delay="100">
              Contact with PeyaraHut.com first time We provide the best service with cheap rate  <a href="https://peyarahut.com" target="_blank">peyarahut.com</a>. 
            </p>
          </div>
        </div>
          ...
          <div class="col-md-5">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                <p><span class="d-block">Address:</span> <span> Barisal,Kuriana</span></p>
                <p><span class="d-block">Phone:</span> <span> 01612321823</span></p>
                <p><span class="d-block">Email:</span> <span> peyarahut@yahoo.com</span></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="section footer-section">
      <div class="container">
        ...
        <div class="row bordertop text-center pt-5">
          <p class="col-md-12">&copy; Copyright 2018. All Rights Reserved. <br> Designed &amp; Developed by <a href="https://free-template.co/">Free-Template.co</a> <br>Distributed by <a href="https://themewagon.com/">ThemeWagon</a></p>
